      ...
      <section className="bg-white">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            ...
            <p className="font-light text-gray-900 sm:text-xl ">
              Team members bring diverse skills and perspectives, working
          ...
          >
            ...
            >
              ...
              <ul className="flex justify-center mt-4 space-x-4">
                <li>
                  <a
                    href="https://www.facebook.com/devabubakkarsajid"
            ...
            >
              ...
              />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 ">
                <a href="#">Usman Amanat </a>
              </h3>
              <p>Investor and IT Entrepreneur</p>
              <ul className="flex justify-center mt-4 space-x-4">
                <li>
                  <a
                    href="#"
            ...
            >
              ...
              />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 ">
                <a href="https://mi-networks.web.app">Rehanna William </a>
              </h3>
              <p>Sales</p>
              <ul className="flex justify-center mt-4 space-x-4">
                <li>
            ...
            >
              ...
              />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-900 ">
                <a href="https://mi-networks.web.app">Syed Noman Shahid </a>
              </h3>
